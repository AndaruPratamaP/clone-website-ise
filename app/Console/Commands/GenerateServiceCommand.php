...
{
    protected $signature = 'ise:service {name : The name of the service}';
    ...
    public function handle()
    {
        ...
        $serviceDirectory = app_path("Core/Application/Services/{$name}");
        ...
        $this->info("Service: {$servicePath}");
        $this->info("Request: {$requestPath}");
        $this->info("Response: {$responsePath}");
    }
}
