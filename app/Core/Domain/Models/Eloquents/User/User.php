...
class User extends model implements AuthenticatableContract
{
    ...
    public function hasPermission($route)
    {
        ...
        $permission_id = Permission::where('route', $route)->first()->getAttribute('id');
        // check if role id and permission id is exist in role_has_permission table
        $roleHasPermission = RoleHasPermission::where('role_id', $role_id)->where('permission_id', $permission_id)->first();
