...
<div x-data="{ open: false }">
    {{-- Mobile Start --}}
    <div class="flex h-20 items-center ml-6 lg:hidden fixed top-0 left-0 z-10 cursor-pointer" @click="open=!open">
    ...
    <div x-bind:class="open==true ? 'bg-black/70 min-h-screen w-full fixed inset-0 z-50' : ''" @click="open=!open">
        <div x-show='open' x-cloak x-transition class="flex-col scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-gray-500 h-screen w-[260px] bg-[#15161A] text-white fixed top-0 left-0 z-10 flex lg:hidden px-[30px] py-[40px] text-lg scroll overflow-y-auto">
            ...
            <div class="flex flex-col items-center space-y-4">
                ...
                <a href="/coming-soon" class="flex flex-row items-center gap-2 hover:text-red-500 group"><x-heroicon-s-arrow-left-on-rectangle class="w-6 h-6 text-white group-hover:text-red-500" />Logout</a>
            </div>
        </div>
    </div>
    {{-- Mobile End --}}
