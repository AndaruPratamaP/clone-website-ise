...
<body>
    <div class="card">
        ...
        <div class="content">
            ...
            <a href="{{ $app_url . '/verify/' . $token }}" class="btn">Verifikasi Email</a>
            <!-- h6 align center -->
            <h6 align="center">Tolong jangan balas pesan ini. Email ini dikirim dari alamat email khusus pemberitahuan
                yang tidak dapat menerima email masuk.</h6>
            <!--Garis pembatas-->
            <hr>
            <!-- icon Tiktok, instagram, and youtube, align center -->
            <h6 align="center">
                <a href="https://vt.tiktok.com/ZS8yATae9/" style="text-decoration: none;">
                    <img src="https://res.cloudinary.com/dqpzaw0pm/image/upload/v1675348720/Asset%20ITS%20EXPO/tiktok_jkm9tc.png"
                        width="30" height="30" alt="Tiktok" style="margin-right: 24px;">
                </a>
                <a href="https://www.instagram.com/its_expo/" style="text-decoration: none;">
                    <img src="https://res.cloudinary.com/dqpzaw0pm/image/upload/v1675348720/Asset%20ITS%20EXPO/Instagram_o0ek2q.png"
                        width="30" height="30" alt="Instagram" style="margin-right: 24px;">
                </a>
                <a href="https://youtube.com/@ITSEXPO2021" style="text-decoration: none;">
                    <img src="https://res.cloudinary.com/dqpzaw0pm/image/upload/v1675348720/Asset%20ITS%20EXPO/youtube_mety6r.png"
