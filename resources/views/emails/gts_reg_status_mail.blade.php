...
<html lang="en">
    ...
    <body>
        ...
        >
            ...
            <tr>
                <td><p style="margin: 30px 0px"></p></td>
            </tr>
            <tr>
                <td class="desc-text">
            ...
            <tr>
                <td><p style="margin: 20px 0px"></p></td>
            </tr>
            @if (!$isVerified)
            <!-- If Rejected Start -->
            <tr>
            ...
            <tr>
                <td><p style="margin: 15px 0px"></p></td>
            </tr>
            <tr>
                <td class="btn">
            ...
            <!-- If Accepted Start -->
            <tr>
                <td class="status-ok">Terverifikasi</td>
            </tr>
            <tr>
                <td><p style="margin: 20px 0px"></p></td>
            </tr>
            ...
            <tr>
                <td><p style="margin: 10px 0px"></p></td>
            </tr>
            <tr>
                <td>
