...
<body>
    <table class="container" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td class="title">Forgot Password</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td class="desc-text">
                Silahkan klik kode dibawah ini untuk mengganti password akun anda.
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <a class="verify-btn" href="{{ $app_url . '/forgot/' . $token }}">Forgot Password</a>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td class="desc-text">
                Jika kamu tidak melakukan forgot password, tidak perlu melanjutkan proses
                forgot password.
            </td>
        </tr>
        <tr>
