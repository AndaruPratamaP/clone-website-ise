        ...
        <div class="absolute z-20">
            ...
            <div class="relative">
                ...
                <div class="flex justify-center z-20">
                    <a href="https://www.instagram.com/is_expo/" class="hover:brightness-90">
                        <button class="flex flex-row gap-2 items-center font-['Montserrat'] font-[600] text-[#121316] bg-[#FFEEE4] rounded-[18px]  sm:rounded-[20px] lg:rounded-[24px] px-[18px] sm:px-[20px] lg:px-[24px] py-[11px] sm:py-[12px] lg:py-[14px] text-[11px] min-[450px]:text-[12px] sm:text-[13px] lg:text-[16px]">
                        <x-bi-instagram />
