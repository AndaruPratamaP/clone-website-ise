<div class="relative bg-[#121316] flex min-h-screen w-full justify-center items-center overflow-hidden">
  ...
  <div>
    ...
    <div class="flex justify-center mt-[20px] text-[#ffffff] font-semibold text-base pl-[24px] pr-[24px] lg:pl-[75px] lg:pr-[75px] lg:text-4xl text-center">You are being redirected to &ThinSpace;<span class="underline hover:brightness-75">{{ $long_url }}</span>&ThinSpace;...</div>
  </div>
</div>
