            ...
            <div class="flex justify-center items-center mt-36 mb-20 z-20">
                <div class=" grid gap-0 w-[323px] h-[679px] grid-cols-1 lg:grid-flow-col lg:h-[564px] md:w-[400px] lg:w-[959px] z-20">
                    <div class="z-20 rounded-bl-[22px] rounded-br-[22px] w-[323px] md:w-[400px] h-[422px] order-2 lg:w-[486px] lg:h-[564px] lg:rounded-tl-[45px] lg:rounded-bl-none lg:rounded-br-none lg:order-1 ">
                        <div class="relative py-8 z-20 px-7 lg:px-10 bg-[#191A1E] rounded-bl-[22px] rounded-br-[22px] lg:w-[486px] lg:h-[564px] lg:rounded-none ">
                            <div class=" relative">
                                <img class=" absolute bottom-[16.25rem] md:bottom-[20.25rem] left-[4rem] md:left-[6.75rem] w-[9rem] h-[5.5rem] lg:w-max lg:h-max lg:bottom-[-0.6rem] lg:left-[7rem]" src="{{ asset('images/LoginRegisterDecor1.png') }}" alt="">
                                <img class=" absolute z-30 w-[0.35rem] h-[0.3rem] left-[11.5rem] top-[1rem] lg:left-[23.25rem] lg:top-10 lg:w-max lg:h-max" src="{{ asset('images/Login_Register_Green_Dot.png') }}" alt="">
                            </div>
                            <div class="text-[#FFFFFF] font-montserrat mb-10 drop-shadow-[0_4px_4px_rgba(0,0,0,1)] text-[24px] font-bold lg:font-extrabold lg:text-[48px]">
                                Login Account
                            </div>
                            ...
                            <div class=" relative">
                                ...
                                <div class=" relative">
                                    ...
                                    @error('password')
                                        <span class="text-[#A31400] text-[12px] font-montserrat font-medium">{{ $message }}</span>
                                    @enderror
                                    <button class=" absolute top-[0.25rem]  left-[14.5rem] lg:top-[0.4rem] md:left-[19rem] lg:left-[23.5rem]" x-show="!show" @click="show = !show" type="button">
                                    ...
                                    <button class=" absolute top-[0.25rem]  left-[14.5rem] lg:top-[0.4rem] md:left-[19rem] lg:left-[23.5rem]" type="button" x-show="show" @click="show = !show">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-[17px] h-[16px] lg:w-[17px] lg:h-[21px] text-gray-400">
                    ...
                    <div class=" bg-[#141414] z-20 rounded-tl-[22px] rounded-tr-[22px] w-[323px] md:w-[400px] h-[257px] md:h-[320px] order-1 lg:p-0 lg:rounded-tl-none lg:rounded-tr-none lg:rounded-br-[45px] lg:w-[473px] lg:h-[564px] lg:order-2 ">
                        <div class=" relative">
                            <img class=" absolute hidden lg:block w-[323px] h-[257px] lg:w-[473px] lg:h-[564px]" src="images/Login_FrontDecor.png" alt="">
