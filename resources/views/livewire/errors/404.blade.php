...
<div class="flex flex-col items-center justify-center h-fit lg:min-h-screen sm:min-h-screen bg-[#121316]">
    ...
    <div class="container min-h-screen flex flex-col justify-center items-center relative text-white">
    ...
    <div class="flex relative h-24 items-center justify-center">
        <p class="text-white font-montserrat font-semibold lg:text-xl md:text-xl text-sm leading-9 px-4 xs:px-0 text-center">Sorry, the page you are looking for was not found.</p>
    </div>
