    ...
    <section class=" min-w-full h-[13rem] xs:h-[20rem] sm:h-[27rem] md:h-[30rem] lg:h-[703px] xl:h-[863px]">
        ...
        <div class=" relative" data-aos-duration="1500" data-aos="fade-down" >
            <div class=" absolute top-[1.5rem] xs:top-[2rem] sm:top-[3rem] md:top-[4rem] lg:top-[9rem] xl:top-[7rem] right-[1.75rem] xs:right-[5.5rem] sm:right-[9rem] md:right-[13rem] lg:right-[16rem] xl:right-[19rem]">
                    ...
                    <a href="#more" style="line-height: 80%" class="text-center items-center flex justify-center mt-2 sm:mt-4 lg:mt-4 xl:mt-6 z-30 w-[60px] xs:w-[90px] sm:w-[130px] md:w-[145px] lg:w-[185px] xl:w-[250px] h-[20px] xs:h-[26px] sm:h-[35px] md:h-[40px] lg:h-[43px] xl:h-[58px] from-[#398FBA] to-[#97FBFE] bg-gradient-to-r text-transparent rounded-[24px]" type="button">
                ...
                <div class=" swiper-wrapper">
                    <div class="swiper-slide">
                        <div class=" flex justify-center content-center flex-col bg-[#141414] mx-12 xs:mx-14 sm:mx-20 lg:mx-32 rounded-[20px]">
                            ...
                            <a href="/login" class="text-center items-center flex justify-center mt-4 lg:mt-8 xl:mt-12 z-30 w-[150px] md:w-[175px] lg:w-[212px] xl:w-[321px] h-[35px] md:h-[38px] lg:h-[38px] xl:h-[58px] from-[#398FBA] to-[#97FBFE] bg-gradient-to-r text-transparent rounded-[24px] self-center" type="button">
