...
<div class=" bg-[#121316] min-h-[screen] flex justify-center items-center flex-col relative overflow-hidden">
    ...
    <section class=" w-screen h-[500px] xs:h-[570px] sm:h-[600px] md:h-[670px] lg:h-[1090px] xl:h-[1600px]">
        ...
        <div class="mt-10 sm:mt-14 xl:mt-20">
            <div class=" swiper w-[310px] xs:w-[390px] sm:w-[550px] md:w-[650px] lg:w-[800px] xl:w-[1100px] h-[400px] xs:h-[500px] sm:h-[600px] lg:h-[720px] xl:h-[1085px]">
                ...
                <div class="hidden p-10 rounded-full swiper-button-prev lg:block" style=" color: white; background-color: #173F52; left: 0;"></div>
                <div class="p-10 rounded-full swiper-button-next" style=" color: white; background-color: #173F52; right: 0"></div>
            </div>
        </div>
    </section>
    {{-- section 5 --}}
    ...
    <section class=" mt-5 xl:mt-10 w-screen h-[200px] lg:h-[330px] xl:h-[470px]">
        ...
        <div class="z-30 flex flex-col content-center justify-center ">
            ...
            <div class="grid self-center grid-cols-3 gap-3 mt-8 md:mt-12 lg:mt-16 sm:gap-6 md:gap-7 lg:gap-10">
                <div class="flex flex-col content-center justify-center ">
...
// Set the countdown date and time
const countdownDate_dsux = new Date('August 19, 2023 00:00:00').getTime();
