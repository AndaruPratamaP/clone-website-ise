<div class="relative font-montserrat pt-[68px] md:pt-[110px] xl:pt-40  bg-[#121316] h-auto text-white overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-9">
            ...
            <div class="relative h-[245px] md:h-[500px] lg:h-[600px] xl:h-[720px]">
                <div class="relative top-[35px] md:top-28 lg:top-32 xl:top-[200px]">
                    ...
                    <div class="xl:mt-16"><a class="" href="#"><button class="px-[17.791px] md:px-6 lg:px-8 xl:px-10 py-[6.227px] md:py-2 lg:py-3 xl:py-[14px] rounded-full bg bg-gradient-to-r from-[#398FBA] to-[#97FBFE] text-white text-[9px] md:text-base lg:text-lg xl:text-xl">Explore Now</button></a></div>
                </div>
    ...
    {{-- End Hero Section --}}
    {{-- About Section --}}
    <section id="about" class="relative mt-9 md:mt-24 lg:mt-32 xl:mt-48 xl:py-48 mx-auto h-[500px] md:h-[550px] xl:h-[1100px]">
        <img class="absolute md:hidden lg:block lg:h-[730px] lg:-top-36 xl:top-0" src="{{ asset('/images/ds-academy/bg-about.png') }}"/>
        <div class="relative">
            <div class="relative">
                <img class="absolute h-[180px] md:h-[290px] lg:h-[340px] xl:h-auto top-[330px] md:top-[140px] lg:top-[100px] xl:top-[179px] left-[29px] md:left-[50px] lg:left-[88px] xl:left-[105px]" src="{{ asset('/images/ds-academy/about-1.png') }}">
                <img class="absolute h-[101.244px] md:h-[180px] lg:h-[200px] xl:h-auto top-[330px] md:top-[200px] lg:top-[180px] xl:top-[330px] right-[10px] md:right-[20px] lg:right-[50px] xl:right-[33px]" src="{{ asset('/images/ds-academy/about-2.png') }}">
                   </div>
