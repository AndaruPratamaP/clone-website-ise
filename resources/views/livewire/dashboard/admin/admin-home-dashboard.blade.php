    ...
    <div>
        ...
        <div class="flex flex-row flex-wrap gap-4 mt-4 w-full">
            <div
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-blue-400 mt-3 sm:mt-4 self-end">{{ $this->registered }}
                </h2>
            </div>
            <div
                class="flex flex-col justify-between items-start bg-[#191A1E] rounded-3xl max-w-xs lg:max-w-sm w-full px-7 pt-4 pb-6">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-blue-400 mt-3 sm:mt-4 self-end">{{ $this->verified }}
                </h2>
            </div>
        </div>
    </div>
