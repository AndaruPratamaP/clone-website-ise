                ...
                <div class="flex flex-col max-w-xl lg:max-w-full justify-center items-center mx-auto">
                        ...
                        <form x-show="!isSubmitted">
                            <div>
                                ...
                                <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group">
                                    ...
                                    <input type="email" name="email" id="email" wire:model="email" class="block py-0 px-0 w-full text-[11px] lg:text-[18px] font-medium text-[#7C7C7C] bg-transparent border-0 border-b border-white appearance-none dark:text-white dark:border-white dark:focus:border-[#66C1A7] focus:outline-none focus:ring-0 peer" placeholder="Masukkan email aktif kamu" required />
                                    @error('email')
                                        <span class="text-red-500 text-sm font-thin">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group">
                                    <label for="sumber_informasi" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white">Sumber Informasi <span class="text-[#FF1F00]">*</span>
                                    </label>
                                    <select id="sumber_informasi" name="sumber_informasi" wire:model="sumber_informasi" class="block py-0 px-0 w-full text-[11px] lg:text-[18px] font-medium text-[#7C7C7C] bg-transparent border-0 border-b border-white appearance-none dark:border-white dark:focus:border-[#66C1A7] focus:outline-none focus:ring-0  peer">
                                ...
                                <div class="relative z-0 w-full mb-6 group cursor-pointer">
                                    <label for="bukti_ig" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white">
                                    ...
                                    <label class="mt-[13px] w-max px-2 py-1 lg:py-[4px] flex flex-col items-center bg-[#1C1C1C] text-blue rounded-[6px] shadow-lg border border-[#66C1A7] cursor-pointer">
                                        <div class="flex flex-row items-center gap-1 hover:brightness-75">
                                          ...
                                          " wire:model="bukti_ig" id="bukti_ig" name="bukti_ig" />
                                        </div>
                                    </label>
                                    @error('bukti_ig')
                                        <span class="text-red-500 text-sm font-thin">{{ $message }}</span>
                    ...
                    <div class="flex flex-col justify-center" x-show="isSubmitted">
                        ...
                        <div class="flex flex-row justify-center gap-[16px] mt-6 sm:mt-[39px]">
                            <div>
                                <a href="#" class="items-center flex justify-center text-white bg-[##1C1C1C] font-semibold ring-2 ring-[#66C1A7] ring-inset font-Inter rounded-md text-[12px] lg:text-[16px] w-28 sm:w-[146.5px] lg:w-[387.5px] h-[42px] lg:h-[48px] px-5 py-2.5 text-center  dark:focus:ring-yellow-500 hover:opacity-80">Tutup</a>
                            </div>
                            <div>
                                <a href="#" class="items-center flex justify-center text-white bg-gradient-to-r from-[#006C56] to-[#AFD196] hover:bg-blue-800 focus:ring-4 focus:outline-none font-semibold font-Inter rounded-md text-[12px] lg:text-[16px] w-28 sm:w-[146.5px] lg:w-[387.5px] h-[42px] lg:h-[48px] px-[12px] lg:px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-200 dark:focus:ring-[#66C1A7] hover:opacity-80">Masuk ke dashboard</a>
                            </div>
                        </div>
                    </div>
