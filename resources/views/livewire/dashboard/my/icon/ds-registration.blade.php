  ...
  <div class="flex justify-center relative z-20 md:-mt-[85px]">
    ...
    <div class="max-w-2xl lg:max-w-full mx-4 md:mx-8 pb-10 h-max lg:h-max bg-[#1C1C1C] shadow-xl">
      ...
      <div class="flex flex-col max-w-xl lg:max-w-full justify-center items-center mx-auto">
        ...
        >
          Form Pendaftaran Data Science Academy
        </h1>
        <div class="relative flex flex-row pb-1 w-full">
          <div
            class="relative max-w-[228px] w-full h-[2px] bg-white flex self-center justify-self-center"
          ...
          <div
            class="relative max-w-[415px] w-full h-[2px] bg-white flex self-center justify-self-center"
          ...
          >
            <svg class="w-4 lg:w-12" viewBox="0 0 30 28" xmlns="http://www.w3.org/2000/svg">
              <path
                class=""
                x-bind:class="step >= 2 ? 'fill-white' : ''"
          ...
          >
            <svg class="w-4 lg:w-12" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
              <path
                class=""
                x-bind:class="step >= 3 ? 'fill-white' : ''"
          ...
          >
            <svg class="w-4 lg:w-12" viewBox="0 0 31 31" xmlns="http://www.w3.org/2000/svg">
              <path
                class=""
                x-bind:class="step >= 4 ? 'fill-white' : ''"
          ...
          <div class="relative max-w-[228px] w-full h-[2px] bg-white flex self-center justify-self-center"></div>
        </div>

        <div class="relative flex flex-row pb-6 w-full">
          <div class="relative max-w-[115px] w-full h-[2px] bg-none flex self-center justify-self-center"></div>
          <div>
            <p
              class="text-[8px] lg:text-lg font-bold bg-clip-text text-transparent whitespace-nowrap"
              x-bind:class="step >= 1 ? 'bg-gradient-blue-r' : 'bg-white'"
            >
              Identitas Tim
            </p>
          ...
          <div
            class="relative max-w-[27px] xs:max-w-[125px] w-full h-[2px] bg-none flex self-center justify-self-center"
          ></div>
          <div>
            <p
              class="text-[8px] lg:text-lg font-bold bg-clip-text text-transparent whitespace-nowrap"
          ...
          <div class="relative max-w-[140px] w-full h-[2px] bg-none flex self-center justify-self-center"></div>
          <div>
            <p
              class="text-[8px] lg:text-lg font-bold bg-clip-text text-transparent whitespace-nowrap"
              x-bind:class="step >= 3 ? 'bg-gradient-blue-r' : 'bg-white'"
        ...
        <div class="flex flex-row mb-6 gap-x-10 xs:gap-x-20" x-bind:class="step <= 3 ? '' : 'hidden'">
          <div class="flex flex-col">
            <p x-on:click="step = 1" class="cursor-pointer text-white text-xs xs:text-sm lg:text-xl font-bold">Ketua</p>
            <div
              class="relative w-[80px] lg:w-[140px] h-[2px] bg-white flex"
              x-bind:class="step >= 1 ? 'bg-gradient-blue-r' : 'bg-white'"
            ></div>
          </div>
          <div class="flex flex-col">
            <p x-on:click="step = 2" class="cursor-pointer text-white text-xs xs:text-sm lg:text-xl font-bold">
              Anggota 1
            </p>
            <div
              class="relative w-[80px] lg:w-[140px] h-[2px] bg-white flex"
          ...
          <div class="flex flex-col">
            <p x-on:click="step = 3" class="cursor-pointer text-white text-xs xs:text-sm lg:text-xl font-bold">
              Anggota 2
            </p>
            <div
              class="relative w-[80px] lg:w-[140px] h-[2px] bg-white flex"
        ...
        <div class="ml-[26px] mr-[24px] lg:ml-[108px] lg:mr-[128px]">
          <form class="w-full" enctype="multipart/form-data" wire:submit.prevent="submit">
            <div class="max-w-[362px] lg:max-w-[780px] w-full">
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 1 ? '' : 'hidden'">
                <label for="nama_tim" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Nama Tim
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 1 ? '' : 'hidden'">
                <label for="alasan_tim" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Apa alasan tim Anda mengikuti ISE! Data Science Academy?
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
                  type="text"
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 1 ? '' : 'hidden'">
                <label for="harapan_tim" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Apa yang tim Anda harapkan dari ISE! Data Science Academy?
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
                  type="text"
                  name="harapan_tim"
                  id="harapan_tim"
                  wire:model="harapan_tim"
                  class="block py-0 px-0 w-full text-[11px] lg:text-[18px] font-medium text-[#7C7C7C] bg-transparent border-0 border-b border-white appearance-none dark:text-white dark:border-white dark:focus:border-[#66C1A7] focus:outline-none focus:ring-0 peer"
                  placeholder="Masukkan harapan kamu"
                  required
                />
                @error('harapan_tim')
                <span class="text-red-500 text-sm font-thin">{{ $message }}</span>
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 1 ? '' : 'hidden'">
                <label for="tujuan_tim" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Apa yang dapat kamu lakukan dengan ilmu yang diperoleh pasca ISE! Data Science Academy?
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
                  type="text"
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 1 ? '' : 'hidden'">
                <label
                  for="sumber_informasi"
                  class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Darimana tim Anda mendapatkan informasi terkait ISE! Data Science Academy?
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <select
                name="referral"
              ...
              <div
                class="flex items-center flex-row mt-[27px] mb-[20px] lg:mb-[39px] space-x-4 font-medium text-[11px] lg:text-[17px]"
              ...
              >
                ...
                />
                <label class="text-white" for="setuju-kebijakan"
                  >Dengan ini saya menyatakan bahwa tim saya siap mengikuti ISE! Data Science Academy serta siap
                  mematuhi <a href="/terms-and-conditions" class="text-[#66C1A7]" target="_blank">peraturan</a> yang
                  berlaku nantinya</label
                >
                @error('agree')
                <span class="text-red-500 text-sm font-thin">{{ $message }}</span>
                @enderror
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="nama_ketua" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Nama Lengkap <span class="text-[#FF1F00]">*</span>
                </label>
                <input
                  type="text"
                  name="nama_ketua"
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 3 ? '' : 'hidden'">
                <label
                  for="nama_anggota1"
                  class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Nama Lengkap <span class="text-[#FF1F00]">*</span>
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 4 ? '' : 'hidden'">
                <label
                  for="nama_anggota2"
                  class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Nama Lengkap <span class="text-[#FF1F00]">*</span>
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="univ_ketua" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Asal Institusi
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="email_ketua" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Email
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="wasap_ketua" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Whatsapp
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[45px] group" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="insta_ketua" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Instagram
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[30px] group" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="twib_ketua" class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Link Twibbon
                  <span class="text-[#FF1F00]">*</span>
                </label>
                <input
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[30px] group" x-bind:class="step == 3 ? '' : 'hidden'">
                <label
                  for="twib_anggota1"
                  class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Link Twibbon
              ...
              <div class="relative z-0 w-full mb-[15px] lg:mb-[30px] group" x-bind:class="step == 4 ? '' : 'hidden'">
                <label
                  for="twib_anggota2"
                  class="block leading-normal text-[12px] lg:text-[20px] font-medium text-white"
                  >Link Twibbon
              ...
              <div class="relative z-0 w-full mb-5 group cursor-pointer" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="cv_ketua" class="block leading-normal text-[12px] lg:text-[19px] font-medium text-white">
                ...
                <div class="text-slate-300 text-sm mt-0.5">Max size 1mb (.pdf)</div>
                @error('cv_ketua')
                <span class="text-red-500 text-sm font-thin">{{ $message }}</span>
                @enderror
              </div>
              <div class="relative z-0 w-full mb-5 group cursor-pointer" x-bind:class="step == 3 ? '' : 'hidden'">
                <label for="cv_anggota1" class="block leading-normal text-[12px] lg:text-[19px] font-medium text-white">
                  CV <span class="text-[#FF1F00]">*</span>
                </label>
                <label
                  class="mt-[13px] w-max px-2 py-1 lg:py-[4px] flex flex-col items-center bg-[#1C1C1C] text-blue rounded-[6px] shadow-lg border border-[#348BB6] cursor-pointer"
              ...
              <div class="relative z-0 w-full mb-5 group cursor-pointer" x-bind:class="step == 4 ? '' : 'hidden'">
                <label for="cv_anggota2" class="block leading-normal text-[12px] lg:text-[19px] font-medium text-white">
                  CV <span class="text-[#FF1F00]">*</span>
                </label>
                <label
                  class="mt-[13px] w-max px-2 py-1 lg:py-[4px] flex flex-col items-center bg-[#1C1C1C] text-blue rounded-[6px] shadow-lg border border-[#348BB6] cursor-pointer"
              ...
              <div class="relative z-0 w-full mb-3 group cursor-pointer" x-bind:class="step == 2 ? '' : 'hidden'">
                <label for="bukti_ketua" class="block leading-normal text-[12px] lg:text-[19px] font-medium text-white">
              ...
              <div class="relative z-0 w-full mb-3 group cursor-pointer" x-bind:class="step == 4 ? '' : 'hidden'">
                <label
                  for="bukti_anggota2"
                  class="block leading-normal text-[12px] lg:text-[19px] font-medium text-white"
                >
              ...
              <div class="flex flex-row gap-x-2 sm:gap-x-5 mt-8 sm:mt-12">
                <button
                  x-show="step >= 2"
                  type="button"
                  @click=" step-- "
                  class="text-white border-2 border-blue-300 hover:brightness-90 focus:ring-4 focus:outline-none font-semibold font-Inter rounded-md text-[16px] w-full h-[42px] lg:h-[48px] px-5 py-2 lg:py-2.5 text-center hover:opacity-80"
                ...
                <button
                  ...
                  type="button"
                  @click=" step++ "
                  class="text-white bg-gradient-blue-r hover:brightness-90 focus:ring-4 focus:outline-none font-semibold font-Inter rounded-md text-[16px] w-full h-[42px] lg:h-[48px] px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-200 dark:focus:ring-[#348BB6] hover:opacity-80"
                >
                  Continue
                </button>
                <button
                x-show="step == 4"
                type="submit"
                class="text-white bg-gradient-blue-r hover:brightness-90 focus:ring-4 focus:outline-none font-semibold font-Inter rounded-md text-[16px] w-full h-[42px] lg:h-[48px] px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-200 dark:focus:ring-[#348BB6] hover:opacity-80"><span wire:loading.remove>Submit</span>         <div wire:loading
                class="inline-block h-6 w-6 animate-spin rounded-full lg:mt-1 brightness-90 border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
                role="status">
                <span
