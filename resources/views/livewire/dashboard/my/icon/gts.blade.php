...
<div class=" min-h-screen w-full p-4 xl:pl-12 font-poppins">
        ...
        <div class="flex flex-col-reverse xl:flex-row gap-x-5 gap-y-5">
            <div class="flex rounded-xl bg-[#121316] sm:bg-[#191A1E] py-8 px-9 max-w-4xl">
                <div class="flex flex-col text-white">
                    ...
                    <p class="text-sm sm:text-base font-light text-justify pt-4">Selamat tim kamu berhak mengikuti Data Science
                        Academy ISE! 2023.
                        Selamat tim kamu berhak mengikuti Data Science Academy ISE! 2023. Selamat tim kamu berhak
                        mengikuti Data Selamat tim kamu berhak mengikuti Data Science Academy ISE! 2023. Apakah ingin
                        mengikuti kegiatan ini? Science Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini? Apakah
                        ...
                        Science Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini? Apakah ingin mengikuti kegiatan?
                    </p>
                </div>
            </div>


            <div class="flex rounded-xl bg-[#191A1E] p-5 max-w-4xl xl:max-w-[400px] w-full shrink-0 justify-center items-center">
                <div class="flex flex-col text-white items-center">
                    <p class="text-xl font-medium">Pendaftaran Ditutup</p>
    ...
    <section>
            <div class="flex rounded-xl bg-[#121316] sm:bg-[#191A1E] my-8 pb-16 px-6 h-[250px] items-center justify-center max-w-[896px] lg:max-w-[1150px] 2xl:max-w-[1317px]">
                ...
                <span class="flex flex-row max-w-xl xl:max-w-[800px] 2xl:max-w-4xl w-full justify-between items-center h-[4px] bg-[#333333] text-white ">
                    <div class="flex flex-col w-24 text-center translate-y-3.5 sm:translate-y-[1.125rem] md:translate-y-4 lg:translate-y-5 xl:translate-y-6 -translate-x-5 sm:-translate-x-10">
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins font-bold">Jun 2022</p>
                        ...
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins text-center">Bionix <br> Student <br> Level</p>
                    </div>
                    <div class="flex flex-col w-24 text-center translate-y-2 lg:translate-y-3 -translate-x-4">
                        ...
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins text-center">IS <br> Class</p>
                    </div>
                    <div class="flex flex-col w-24 text-center translate-y-2 lg:translate-y-3 -translate-x-2">
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins font-bold">Jul 2022</p>
                        <div class="sm:w-5 sm:h-5 w-4 h-4 bg-black mx-auto rounded-full">
                            <div class="sm:w-4 sm:h-5 w-3 h-4 bg-gradient-blue-r rounded-full mx-auto"></div>
                        </div>
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins">ICON <br> Academy</p>
                    </div>
                    <div class="flex flex-col w-24 text-center translate-y-3.5 sm:translate-y-4 lg:translate-y-5 xl:translate-y-6 translate-x-2">
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins font-bold">Sep 2022</p>
                        <div class="sm:w-5 sm:h-5 w-4 h-4 bg-black mx-auto rounded-full">
                            <div class="sm:w-4 sm:h-5 w-3 h-4 bg-gradient-blue-r rounded-full mx-auto"></div>
                        </div>
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins">BIONIX <br> College <br> Level</p>
                    </div>
                    <div class="flex flex-col w-24 text-center translate-y-2 lg:translate-y-3 translate-x-4">
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins font-bold">Sep 2022</p>
                        <div class="sm:w-5 sm:h-5 w-4 h-4 bg-black mx-auto rounded-full">
                        ...
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins">Virtual <br> Tour</p>
                    </div>
                    <div class="flex flex-col w-24 text-center translate-y-2 lg:translate-y-3 translate-x-5 sm:translate-x-10">
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins font-bold">Nov 2022</p>
                        <div class="sm:w-5 sm:h-5 w-4 h-4 bg-black mx-auto rounded-full">
                            <div class="sm:w-4 sm:h-5 w-3 h-4 bg-gradient-blue-r rounded-full mx-auto"></div>
                        </div>
                        <p class="text-[9px] sm:text-[11px] md:text-xs lg:text-sm xl:text-base font-poppins">Grand <br> Talkshow</p>
                    </div>
                </span>
                </div>
            </div>
...
{{-- <div class="min-h-screen w-full p-4 xl:pl-12 font-poppins">
    ...
    <section>
        <div class="flex mb-8">
            <p class="text-2xl text-center text-white font-bold tracking-[0.09em] md:tracking-[0.09em]">Halo, Selamat Datang di Dashboard <span
    ...
    <section class="flex flex-col-reverse md:flex-row justify-center gap-x-8 w-full">
            <div class="flex flex-col my-1.5 w-full items-center md:w-full">
                ...
                <div
                    ...
                    <div class="flex flex-row gap-x-6 items-center w-full">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-2xl bg-gradient-blue-r font-bold bg-clip-text text-transparent">Terdaftar</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col gap-y-1">
                        ...
                        <p class="flex text-white font-lg text-base font-poppins font-medium tracking-wider mb-3">Institut
                            Teknologi Bandung</p>
                ...
                <div class="flex md:hidden md:self-start self-center text-2xl text-[#B5B3BC] font-bold mt-6 mb-4">Pengumuman</div>
                <div class="flex md:hidden max-w-[580px] md:max-w-[477px] w-full rounded-xl bg-[#191A1E] mb-1.5 py-8 px-9 justify-start items-center">
                    <div class="flex flex-col gap-y-3">
                        <p class="flex text-white font-lg text-lg sm:text-2xl font-poppins font-bold tracking-wider">Lorem Ipsum</p>
                        <p class="text-sm sm:text-base text-white font-light text-justify">Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini? Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini?Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini?Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin  mengikuti kegiatan ini?Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin
            ...
            <div class="flex flex-col items-center md:items-start my-1.5 w-full">
                ...
                <div class="hidden md:flex max-w-[580px] md:max-w-[477px] w-full rounded-xl bg-[#191A1E] mb-1.5 py-8 px-9 justify-start items-center">
                    <div class="flex flex-col gap-y-3">
                        <p class="flex text-white font-lg text-2xl font-poppins font-bold tracking-wider">Lorem Ipsum</p>
                        <p class="text-base text-white font-light text-justify">Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini? Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini?Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin mengikuti kegiatan ini?Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin  mengikuti kegiatan ini?Selamat tim kamu berhak mengikuti  UX Academy ISE! 2023. Apakah ingin
                            mengikuti kegiatan ini?</p>
                    </div>
                </div>
