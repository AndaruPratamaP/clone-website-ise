        ...
        <div class="px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 2xl:px-36 font-['Montserrat']">
          ...
          <form wire:submit.prevent="submit" enctype="multipart/form-data">
            <div>
                  ...
                  <div class="flex flex-col my-6 md:my-8 lg:my-10 xl:my-12">
                    <label for="account_owner" class="inline text-xs font-semibold lg:text-base 2xl:text-xl"
                      >Nama Pemilik Rekening<span class="text-[#FF1F00] ml-1">*</span></label
                    >
                    <input
                      id="account_owner"
                      wire:model="account_owner"
                      class="w-full bg-[#1C1C1C] border-solid border-b-2 p-1 mt-2 font-[500] focus:outline-none text-xs lg:text-xl placeholder:text-[#7C7C7C] hover:placeholder:text-[#6B6B6B] hover:text-[#6B6B6B] hover:border-b-[#6B6B6B] hover:bg-transparent focus:text-[#ffa672] focus:placeholder:text-[#ffa672] focus:border-b-[#ffa672] lg:focus:text-xl lg:placeholder:text-xl @error('account_owner') border-b-red-500 text-red-500 @else border-b-gray-300 text-[#7C7C7C] @enderror"
                      type="text"
                      placeholder="Masukkan nama pemilik rekening kamu"
                      required
                    />
                    @error('account_owner')
                    <span class="pt-2 text-xs text-red-500 lg:text-base">{{ $message }}</span>
                  ...
                  <div class="flex flex-col my-6 md:my-8 lg:my-10 xl:my-12">
                    <label for="bank_name" class="inline text-xs font-semibold lg:text-base 2xl:text-xl"
                      >Bank yang Digunakan<span class="text-[#FF1F00] ml-1">*</span></label
                    >
                    <input
                      id="bank_name"
                      wire:model="bank_name"
                      class="w-full bg-[#1C1C1C] border-solid border-b-2 p-1 mt-2 font-[500] focus:outline-none text-xs lg:text-xl placeholder:text-[#7C7C7C] hover:placeholder:text-[#6B6B6B] hover:text-[#6B6B6B] hover:border-b-[#6B6B6B] hover:bg-transparent focus:text-[#ffa672] focus:placeholder:text-[#ffa672] focus:border-b-[#ffa672] lg:focus:text-xl lg:placeholder:text-xl @error('bank_name') border-b-red-500 text-red-500 @else border-b-gray-300 text-[#7C7C7C] @enderror"
                      type="text"
                      placeholder="Masukkan Bank yang kamu gunakan"
                      required
                    />
                    @error('bank_name')
                    <span class="pt-2 text-xs text-red-500 lg:text-base">{{ $message }}</span>
                  ...
                  <div class="font-['Montserrat']">
                    ...
                    <p class="mt-8 text-xs sm:text-base lg:text-xl">Jumlah yang harus dibayarkan:
                        <br> <span class="font-bold">Rp 89.000,00</span>
                        </p>
                </div>
                  <div class="my-6 md:my-8 lg:my-10 xl:my-12">
                    <label for="payment_file" class="mb-4 text-xs font-semibold lg:text-base 2xl:text-xl"
                      >Upload Bukti Pembayaran<span class="text-[#FF1F00] ml-1">*</span>
                    </label>
                    <label
                      class="mt-3 mb-1 px-3 py-2 lg:py-3 flex h-full bg-[#1C1C1C] text-blue rounded-[6px] shadow-lg border cursor-pointer w-fit xs:pr-28 @error('payment_file') border-red-500 @else border-[#ffa672] @enderror"
                    >
                      <div
