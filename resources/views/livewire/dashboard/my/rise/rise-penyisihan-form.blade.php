        ...
        <div class="px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 2xl:px-36 font-['Montserrat']">
          ...
          <form wire:submit.prevent="submit" enctype="multipart/form-data">
            <div>
                  ...
                  <div class="my-6 md:my-8 lg:my-10 xl:my-12">
                    <label for="poster_file" class="mb-4 text-xs font-semibold lg:text-base 2xl:text-xl"
                      >Upload File Poster<span class="text-[#FF1F00] ml-1">*</span>
                    </label>
                    <label
                      class="mt-3 mb-1 px-3 py-2 lg:py-3 flex h-full bg-[#1C1C1C] text-blue rounded-[6px] shadow-lg border cursor-pointer w-fit xs:pr-28 @error('poster_file') border-red-500 @else border-[#ffa672] @enderror"
                    >
                      <div class="flex flex-row items-center gap-1">
                        <x-heroicon-s-cloud-arrow-up
                          class="w-4 lg:w-8 h-4 lg:h-8 @error('poster_file') text-red-500 @else text-slate-100 @enderror"
                        />
                        <input
                          type="file"
                          class="block w-44 lg:w-56 text-xs lg:text-sm file:mr-0 lg:file:mr-4 file:py-1 lg:file:py-2 file:rounded-md file:border-0 file:text-xs lg:file:text-sm file:font-semibold file:bg-transparent file:cursor-pointer cursor-pointer @error('poster_file') file:text-red-500 text-red-500 @else file:text-white text-gray-500 @enderror"
                          wire:model="poster_file"
                          id="poster_file"
                          name="poster_file"
                          required
                        />
                    ...
                    @enderror
                    <label class="block text-xs lg:text-base 2xl:text-xl text-[#7C7C7C]"
                      >Max size 3mb (*.jpg, *.jpeg, *.png)</label
                    >
                  </div>
            </div>
          </form>
